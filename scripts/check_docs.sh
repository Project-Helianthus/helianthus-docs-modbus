...
check_sunspec_v2_contract() {
  ...
  grep -Fq 'remains opaque under V2.' "$document"
	...
	grep -Fq '707, 708, 713, 714, 715, 802, 803, 804, 805, 806, 807, 808, and 809, and the terminal block.' "$document"
  ...
  grep -Fq 'No point in either model creates a write method, send authority, operation admission,' "$document"
	grep -Fq 'Models 704 through 706 and 709 through 712 remain outside this V2 wave and remain opaque.' "$document"
