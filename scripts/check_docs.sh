...
check_bms_contract() {
  ...
  grep -Fq 'The two extension slices remain opaque words until an exact, versioned field definition' "$document"
  ...
  grep -Fq 'Catalog registration, executable detection, automatic runtime admission,' "$document"
